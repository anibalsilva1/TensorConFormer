...
from .layers import Tokenizer, Detokenizer, TensoFormerEncoder, DGDecoder
from models import TransformerEncoder


class TensorConFormer(nn.Module):
    ...
    def setup(self):
        ...
        self.decoder_in = DGDecoder(hidden_dim=self.hidden_dim,
                                    embed_dim=self.embed_dim,
